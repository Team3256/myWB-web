...
class EventsAttendancePage extends StatefulWidget {
  @override
  _EventsAttendancePageState createState() => _EventsAttendancePageState();
}

class _EventsAttendancePageState extends State<EventsAttendancePage> {
